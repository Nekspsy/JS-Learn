...
// two letters from each of his neighbors’ names. As he collects signatures, he insists that his neighbors keep 
...
function whoIsPaying(name) {
  // console.log(name.length > 2 ? [name, name.slice(0,2)] : [name])

...
class ExtendedArray extends Array {
	sum() {
		// sum - аккумулятор, num - каждое число в массиве, 0 - начальное число
...
const myExtendedArray2 = new ExtendedArray(10, 4, 5, 'qwe')
...
// myArray.sum is not a function - Доступа к методу sum для экземпляров массивов нет
// const myArray = [1, 2, 3]
// myArray.sum()